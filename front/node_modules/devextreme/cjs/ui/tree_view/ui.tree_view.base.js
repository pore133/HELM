...
var TreeViewBase = _ui.default.inherit({
    ...
    _getItemExtraPropNames: function() {
        return ["url", "linkAttr"]
    },
    ...
    _detachExpandEvent: function(itemsContainer) {
    ...
    expandAll: function() {
        ...
        Promise.allSettled(expandingPromises).then((function() {
            ...
            return null === (_this16$_allItemsExpa = _this16._allItemsExpanded) || void 0 === _this16$_allItemsExpa ? void 0 : _this16$_allItemsExpa.call(_this16)
        }))
    },
