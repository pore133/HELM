...
var SchedulerWorkSpace = function(_WidgetObserver) {
    ...
    _proto._supportedKeys = function() {
        ...
        var onArrowPressed = function(e, key) {
            ...
            e.preventDefault();
            e.stopPropagation();
            var focusedCellData = null === (_a = _this3.cellsSelectionState.focusedCell) || void 0 === _a ? void 0 : _a.cellData;
            if (focusedCellData) {
    ...
    _proto._dateTableScrollableConfig = function() {
        ...
        var config = {
            ...
            onScroll: function() {
                var _a;
                null === (_a = _this4._groupedStrategy.cache) || void 0 === _a ? void 0 : _a.clear()
            }
        };
    ...
    _proto._attachDragEvents = function(element) {
        ...
        _events_engine.default.on(element, DragEventNames.DROP, DRAG_AND_DROP_SELECTOR, (function() {
            ...
            if (!(null === (_a = _this9.dragBehavior) || void 0 === _a ? void 0 : _a.dragBetweenComponentsPromise)) {
                _this9.dragBehavior.removeDroppableClasses();
                return
            }
            null === (_b = _this9.dragBehavior.dragBetweenComponentsPromise) || void 0 === _b ? void 0 : _b.then((function() {
                _this9.dragBehavior.removeDroppableClasses()
            }))
        }))
    };
            ...
            if (!this._cellsSelectionState) {
                ...
                if ((null === selectedCellsOption || void 0 === selectedCellsOption ? void 0 : selectedCellsOption.length) > 0) {
                    var validSelectedCells = selectedCellsOption.map((function(selectedCell) {
                        ...
                        if (!groups || 0 === _this26._getGroupCount()) {
