...
var Scheduler = function(_Widget) {
        ...
        switch (args.name) {
            ...
            case "currentView":
                ...
                this._postponeResourceLoading().done((function(resources) {
                    ...
                    null === (_a = _this2._header) || void 0 === _a ? void 0 : _a.option(_this2._headerConfig());
                    _this2._filterAppointmentsByDate();
    ...
    _proto.createAppointmentForm = function() {
        ...
        var scheduler = {
            ...
            getCalculatedEndDate: function(date) {
    ...
    _proto._initMarkupCore = function(resources) {
        ...
        this._waitAsyncTemplate((function() {
            var _a;
            return null === (_a = _this13._workSpaceRecalculation) || void 0 === _a ? void 0 : _a.resolve()
        }));
        this.createAppointmentDataProvider();
        this._filterAppointmentsByDate();
    ...
    _proto._appointmentsConfig = function() {
        ...
        var config = {
            ...
            getDOMElementsMetaData: function() {
                var _a;
                return null === (_a = _this15._workSpace) || void 0 === _a ? void 0 : _a.getDOMElementsMetaData()
            },
            getViewDataProvider: function() {
                var _a;
                return null === (_a = _this15._workSpace) || void 0 === _a ? void 0 : _a.viewDataProvider
            },
            isVerticalViewDirection: function() {
                return "vertical" === _this15.getRenderingStrategyInstance().getDirection()
            },
            ...
            onContentReady: function() {
                var _a;
                null === (_a = _this15._workSpace) || void 0 === _a ? void 0 : _a.option("allDayExpanded", _this15._isAllDayExpanded())
            }
        };
        return config
    };
    ...
    _proto.showAppointmentPopup = function(rawAppointment, createNewAppointment, rawTargetedAppointment) {
        ...
        if (isCreateAppointment) {
            ...
            this._checkRecurringAppointment(rawAppointment, newTargetedAppointment, appointment.startDate, (function() {
                _this25._editAppointmentData = rawAppointment;
