...
var HeaderPanel = function(_ColumnsView) {
    ...
    _proto._isDisabledDefinedByUser = function(name) {
        ...
        var userItem = null === userItems || void 0 === userItems ? void 0 : userItems.find((function(item) {
            return (null === item || void 0 === item ? void 0 : item.name) === name
        }));
