...
var WorkSpace = function(_InfernoComponent) {
    ...
    _createClass(WorkSpace, [{
        ...
        get: function() {
            ...
            return this.__getterCache.viewDataGenerator = (0, _m_utils.getViewDataGeneratorByViewType)(_this10.props.type)
        }
    }, {
        ...
        get: function() {
            ...
            return this.__getterCache.dateHeaderDataGenerator = new _m_date_header_data_generator.DateHeaderDataGenerator(_this11.viewDataGenerator)
        }
    }, {
        ...
        get: function() {
            ...
            return this.__getterCache.timePanelDataGenerator = new _m_time_panel_data_generator.TimePanelDataGenerator(_this12.viewDataGenerator)
        }
    }, {
        ...
        get: function() {
            ...
            return this.__getterCache.groupPanelData = (_this23$props = _this23.props, currentDate = _this23$props.currentDate, endDayHour = _this23$props.endDayHour, groups = _this23$props.groups, hoursInterval = _this23$props.hoursInterval, intervalCount = _this23$props.intervalCount, startDayHour = _this23$props.startDayHour, type = _this23$props.type, columnCountPerGroup = _this23.viewDataGenerator.getCellCount({
                ...
                endDayHour: endDayHour,
                viewType: type
            }), groupPanelData = (0, _utils3.getGroupPanelData)(groups, columnCountPerGroup, _this23.isGroupedByDate, _this23.isGroupedByDate ? 1 : columnCountPerGroup), groupPanelData);
