/**
 * DevExtreme (bundles/__internal/scheduler/m_recurrence.js)
 * Version: 23.1.6
...
var RecurrenceProcessor = function() {
    ...
    _proto._createRruleIntervalParams = function(options) {
        ...
        var clientOffsets_startDate = _m_utils_time_zone.default.getClientTimezoneOffset(start),
        ...
        var startIntervalDate = _m_utils_time_zone.default.setOffsetsToDate(options.start, [-clientOffsets_startDate, appointmentTimezoneOffset]);
        ...
        var maxViewDate = _m_utils_time_zone.default.setOffsetsToDate(options.max, [-clientOffsets_maxViewDate, appointmentTimezoneOffset]);
