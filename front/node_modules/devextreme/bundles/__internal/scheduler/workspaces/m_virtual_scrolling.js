/**
 * DevExtreme (bundles/__internal/scheduler/workspaces/m_virtual_scrolling.js)
 * Version: 23.1.6
...
var VirtualScrollingDispatcher = function() {
    ...
    _proto.handleOnScrollEvent = function(scrollPosition) {
        ...
        if (scrollPosition) {
            ...
            var verticalStateChanged = (0, _type.isDefined)(top) && (null === (_a = this.verticalVirtualScrolling) || void 0 === _a ? void 0 : _a.updateState(top));
            var horizontalStateChanged = (0, _type.isDefined)(left) && (null === (_b = this.horizontalVirtualScrolling) || void 0 === _b ? void 0 : _b.updateState(left));
